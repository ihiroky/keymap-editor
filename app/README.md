...
`REACT_APP_ENABLE_BROWSER_FILE` | Whether to enable Browser File source. Default is false, values `"1"`, `"on"`, `"yes"`, `"true"` are interpreted as `true`.
...
export REACT_APP_ENABLE_BROWSER_FILE=...
npm run build
```
